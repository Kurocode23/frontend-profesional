...
(0, _jquery2.default)(document).ready(function () {
  ...
  var template = '<article class="tv-show">' + '<div class="left img-container">' + '<img src=":img:" alt=":img alt:">' + '</div>' + '<div class="right info">' + '<h1>:name:</h1>' + '<p>:summary:</p>' + '<button class="like">+1</button>';
  '</div>' + '</article>';
  ...
  (0, _jquery2.default)('#app-body').find('form').submit(function (event) {
    ...
    (0, _jquery2.default)('<div class="loader">').appendTo($tvShowsContainer);
    ...
    _jquery2.default.ajax({
      ...
      var shows = data.map(function (el) {
        return el.show;
      });
